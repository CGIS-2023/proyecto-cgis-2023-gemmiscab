    ...
    <x-slot name="header">
        <nav class="font-semibold text-xl text-gray-800 leading-tight" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li>
                    <a href="#" class="text-gray-500" aria-current="page">Ver receta</a>
                </li>
            </ol>
        </nav>
    </x-slot>
                        ...
                        <div class="mt-4">
                            <x-label for="paciente_id" :value="__('Paciente')" />
                                ...
                                <x-input class="block mt-1 w-full"
                                         type="text"
                                         disabled
                                         value="{{$receta->paciente->user->name}} ({{$receta->paciente->nuhsa}})"
                                />
                        ...
                        <div class="mt-4">
                            <x-label for="farmaceutico_id" :value="__('Farmacéutico')" />
                                <x-input class="block mt-1 w-full"
                                         type="text"
                                         disabled
                                         value="{{$receta->farmaceutico->user->name}} ({{$receta->farmaceutico->numero_colegiado}})"
                                />
                        </div>
