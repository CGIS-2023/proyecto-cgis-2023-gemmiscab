            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if(in_array(Auth::user()->tipo_usuario_id, [1,2]))
                        <x-nav-link :href="route('recetas.index')" :active="request()->routeIs('recetas.index') or request()->routeIs('recetas.create') or request()->routeIs('recetas.edit') or request()->routeIs('recetas.show')">
                            {{ __('Mis recetas') }}
                        </x-nav-link>
                    @endif
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('farmaceuticos.edit', Auth::user()->farmaceutico->id)">
                            {{ __('Mi perfil') }}
                        </x-dropdown-link>
                        @endif
                    </x-slot>
