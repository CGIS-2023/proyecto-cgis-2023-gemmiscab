                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-900 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Número colegiado</th>
                                {{-- <th class="py-3 px-6 text-left">Email</th> --}}
                                <th class="py-3 px-6 text-left">Nº recetas hoy</th>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$farmaceutico->numero_colegiado}}</span>
                                    </div>
                                </td>
                                {{-- <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                ...
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$farmaceutico->recetas()->where('fecha', \Carbon\Carbon::now())->count()}}</span>
                                    </div>
                                </td>
