                    ...
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        ...
                        @else
                            ...
                            @if (Route::has('register-farmaceutico'))
                                <a href="{{ route('register-farmaceutico') }}" class="ml-4 text-sm text-gray-700 underline">Registrarse como farmacéutico</a>
                            @endif
                        @endauth
                    </div>
                @endif
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="text-lg leading-7 font-semibold text-center block" style="width: 100%">
                                    <a target="_blank" href="https://github.com/CGIS-2023/proyecto-cgis-2023-gemmiscab" class="underline text-gray-900 dark:text-white">Proyecto gestión de recetas CGIS 22/23</a>
                                </div>
                            </div>
